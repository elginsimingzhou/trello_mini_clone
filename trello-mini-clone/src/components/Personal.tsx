...
const Personal = () => {
  return (
    <main className="flex justify-center items-center my-auto ">
      <div className="flex flex-col rounded-lg justify-center items-center px-6 py-16 bg-gradient-to-r from-purple-500 to-pink-500 mx-4">
        <svg
        ...
        <p className="text-xl font-semibold text-[#f5f5f5]">
          Junior Data Scientist (Data Science Team)
        </p>
        <Opentask />
      </div>
    </main>
